...
if (!defined('PHPUnit_MAIN_METHOD')) {
    define('PHPUnit_MAIN_METHOD', 'Controllers_TestSuite::main');
}

require_once dirname(__FILE__) . DIRECTORY_SEPARATOR . 'IndexControllerTest.php';
require_once dirname(__FILE__) . DIRECTORY_SEPARATOR . 'ServiceControllerTest.php';
 ...
 */
class Controllers_TestSuite extends PHPUnit_Framework_TestSuite
{
    /**
...
if (PHPUnit_MAIN_METHOD === 'Controllers_TestSuite::main') {
    Controllers_TestSuite::main();
}
