...
{
    public function getModifiedResourcesAtDate($graphUri, $date)
    {
        return $this->getModifiedResourcesAtRange($graphUri, $date, $date);
    }

    public function getModifiedResourcesAtRange($graphUri, $from, $to)
    {
