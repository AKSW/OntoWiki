...
class AjaxUpdateTable
{
    ...
    public function getResultAsArray()
    {
        ...
        try {
            ...
            $errorMsg
                = "SPARQL query failed: normally the following characters are not allowed in the input fields:\n ()\n";
    ...
    function toTable($jsonArray, $query)
    {
        ...
        if (!is_array($jsonArray)) {
            ...
            return "<thead> <tr> <th>Error</th> </tr> </thead> <tbody> <tr> <td><xmp>" . $jsonArray
                . "</xmp></td> </tr> </tbody> ";
        }
        ...
        if (count($bindings) == 0) {
            return "<thead> <tr> <th>Empty result set</th> </tr> </thead> <tbody> <tr> <td><xmp>" . $query->__toString()
                . "</xmp></td> </tr> </tbody> ";
        }
