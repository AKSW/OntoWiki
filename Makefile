...
submodules: # read-only
	...
	git config submodule.extensions/historyproxy.url "https://github.com/nucknorris/historyproxy.git"
	git config submodule.extensions/template.url "https://github.com/AKSW/template.ontowiki.git"
	git config submodule.extensions/contextinfo.url "https://github.com/AKSW/contextinfo.ontowiki.git"
	git config submodule.extensions/imagehelper.url "https://github.com/AKSW/imagehelper.ontowiki.git"
...
submodules-developer: # read-write
	...
	git config submodule.extensions/historyproxy.url "git@github.com:nucknorris/historyproxy.git"
	git config submodule.extensions/template.url "git@github.com:AKSW/template.ontowiki.git"
	git config submodule.extensions/contextinfo.url "git@github.com:AKSW/contextinfo.ontowiki.git"
	git config submodule.extensions/imagehelper.url "git@github.com:AKSW/imagehelper.ontowiki.git"
	git submodule update
